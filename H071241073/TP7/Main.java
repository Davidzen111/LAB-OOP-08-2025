...
public class Main {
    ...
    private static void pinjamItem() {
        try {
            ...
            // Jenis item: Buku atau DVD
            String jenis = item instanceof Book ? "Buku" : "DVD";
            library.getLogger().logActivity(String.format("%s: %s dipinjam oleh %s", jenis, item.title, member.name));
    ...
    private static void kembalikanItem() {
        try {
            ...
            // Jenis item: Buku atau DVD
            String jenis = item instanceof Book ? "Buku" : "DVD";
            library.getLogger().logActivity(String.format("%s: %s dikembalikan oleh %s", jenis, item.title, member.name));
